<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditareRezervare.aspx.cs" Inherits="ProiectMTP.EditareRezervare" UnobtrusiveValidationMode="None"%>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cinema - Editare rezervare</title>
     <!-- Bootstrap core CSS -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="auto-style1">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Editeaza rezervarea aleasa!</h1>
                    <p class="h3 mb-4 text-gray-800">Poti rezerva maxim 10 bilete per utilizator!</p>
                    <asp class="sticky-footer bg-white" style="text-align: center">
    <div class="container my-auto" style="text-align: center">
        <asp:Label ID="Label3" runat="server" Text="Introduceti numarul de bilete pentru modificare:"></asp:Label>
        ...
        <br />
    <asp:Button ID="butonEditare" runat="server" BackColor="Gray" ForeColor="White" Height="55px" Text="Salveaza modificari!" Width="219px" OnClick="butonSalvare_Click" />
        <asp:Label ID="lblMessage" runat="server" ForeColor="Maroon"></asp:Label>
        <asp:Label ID="lbl1" runat="server" ForeColor="#009933"></asp:Label>
        <br />
        <br />
        <br />
        <asp:Label ID="lblMessage1" runat="server" ForeColor="#CC0000"></asp:Label>
        <br />
    </div>
</asp>
                    <!-- DataTales Example -->
